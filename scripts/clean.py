...
if __name__ == "__main__":
    ...
    subprocess.run(
        "curl --silent --output data/geospatial/source/cb_2020_us_nation_5m.zip https://www2.census.gov/geo/tiger/GENZ2020/shp/cb_2020_us_nation_5m.zip".split()
    )
    subprocess.run(
        "unzip -q -o -d data/source data/geospatial/source/cb_2020_us_nation_5m.zip".split()
    )
